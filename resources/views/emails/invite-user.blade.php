...
<table border="0" cellpadding="0" cellspacing="0" width="640" style="max-width: 640px; margin: 0 auto; width: 100%;">	
		<tr>
            ...
            Invitation
                  ...
                  You are invited by <strong>{{ $invite_by }}</strong> to join depositions under <strong>{{ $org }}</strong> Organization.
									</td>
								</tr>
								<tr>
									<td style="padding: 0px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
									Just press the button below to accept the invitation.
									</td>
								</tr>
								<tr>
									<td>
											...
											<tr>
												<td width="260" valign="top">
													<table border="0" cellpadding="0" cellspacing="0" width="100%">
														<tr>
															<td align="center">
																 <a href="{{ $url }}" target="_blank" style="text-decoration: none; background-color: #169bc8; color: #fff; padding: 8px 22px; font-size: 16px; margin-top: 20px;" >Accept Invitation</a>
															</td>
														</tr>
													</table>
												</td>
